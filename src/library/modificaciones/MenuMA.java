 ...
 * @author alanv
 */
public class MenuMA extends javax.swing.JFrame {
    ...
    public MenuMA() {
        ...
        Author a = (Author) autor.getSelectedItem();
        id = a.getIdauthor();
        name.setText(a.getName());
        password.setText(a.getSurname());
    ...
    private void initComponents() {
        ...
        jLabel2.setText("MODIFICAR DE AUTOR");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(MenuMA.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuMA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
